...
public class PushService extends Service {
    ...
    // We need to remember any state between the connections, so we don't use a clean start.
    ...
    public static String MQTT_CLIENT_ID = "androidmqtt";
...
//            String clientID = MQTT_CLIENT_ID + "/" + mPrefs.getString(PREF_DEVICE_ID, "");
        ...
        public void publishArrived(String topicName, byte[] payload, int qos, boolean retained) {
            ...
            Intent intent = new Intent("PUBLISH_ARRIVED");
